...
function startTest(event) {
    ...
    title.textContent = `First tell us a little about yourself`;
}
...
function changeBackgroundPictures() {
    ...
    const imageNames = ['2-closed-black-box-top-45-degree.png', '3-closed-black-box-front.png', '4-open-case-front-no-grip.png', '5-closer-to-tilted-case.png', '6-up-down-no-grip.png', '7-big-small-no-grip.png', '8-all-tips-no-grip.png', '9-phone-with-aqua-cover-open.png', '1-black-box-top.png'];
    let currentIndex = 0;
    let currentImage = 0;
